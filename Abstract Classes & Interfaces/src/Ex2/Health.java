...
public class Health extends Insurance implements InsuranceInfo {
	...
	public Health(String t, double c) {
	...
	public void survey() {
		...
		System.out.println("Are you happy with your health insurance policies?:");
